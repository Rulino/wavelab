...
BASE_SCENE = {
    "materials": {
        "vzduch": {"c": 3.0e8, "absorption": 0.03, "T": 1.0, "R": 0.0, "scatter": 0.0},
        "kov": {"c": 2.5e8, "absorption": 5.0, "T": 0.10, "R": 0.90, "scatter": 1.0, "barrier": True},
        "sklo": {"c": 2.2e8, "absorption": 0.60, "T": 0.85, "R": 0.15, "scatter": 0.25},
        "plast": {"c": 2.4e8, "absorption": 0.35, "T": 0.90, "R": 0.10, "scatter": 0.18},
    },
    "scéna": {
        "zdroj": {
            "x0": 0.5,
        ...
        "objekty": [
            {"x": 1.25, "y": 1.55, "material": "kov", "shape": "circle", "r": 0.12},
            {"x": 1.25, "y": 0.55, "material": "sklo", "shape": "rectangle", "width": 0.22, "height": 0.14, "angle": 0},
            {"x": 2.15, "y": 1.40, "material": "kov", "shape": "triangle", "width": 0.24, "height": 0.22, "angle": 0},
            {"x": 2.10, "y": 0.60, "material": "plast", "shape": "rectangle", "width": 0.18, "height": 0.16, "angle": 30},
        ],
    },
}
...
def write_scene(path: Path, amplitude: float) -> None:
    data = {
        ...
        "scéna": {
            "zdroj": dict(BASE_SCENE["scéna"]["zdroj"]),
            "objekty": [dict(o) for o in BASE_SCENE["scéna"]["objekty"]],
        },
    }

    data["scéna"]["zdroj"]["amplitude"] = float(amplitude)
...
def main() -> None:
    ...
    report.append("  amplitude=0.5 -> слабее / темнее волны")
    report.append("  amplitude=2.0 -> сильнее / ярче волны")
    report.append("")
