...
materials = ["air", "metal", "plastic", "glass", "concrete", "water", "wood", "rubber", "ice", "sand", "brick", "asphalt", "foam"]
...
def material_params(material: str):
    table = {
        ...
        "plastic":  dict(reflect=0.35, absorb=0.18, curve=1.05, warp=0.95, spec=0.42, diffuse=0.58),
