...
# --------------------------------------------------------
filename = "/workspace/my_examples/example_antenna/outputs/metal/constraints/wave_constraint.vtp"  # adjust the path if needed
...
output_filename1 = "/workspace/my_examples/example_antenna/outputs/metal/constraints/wave_field_structured_antenna.vtm"
multiblock_antenna.save(output_filename1)

multiblock = pv.MultiBlock([grid])
output_filename2 = "/workspace/my_examples/example_antenna/outputs/metal/constraints/wave_field_structured.vtm"
