...
print("=== plasticic.py START ===", flush=True)
import sys
...
def run(cfg) -> None:
    ...
    absorption_air = 0.1
    # Second medium: plasticic (absorption according to material)
    absorption_mat = 0.2

    amplitude = 1.0
    lambda_val = 0.3

    # Vertical boundary between media – x < boundary_x: air, x >= boundary_x: plasticic
    boundary_x = 1.5
